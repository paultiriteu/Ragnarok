...
var ResultService = (function () {
    function ResultService(http, httpUtilityService) {
        this.http = http;
        this.httpUtilityService = httpUtilityService;
        this.url = 'api/results'; // URL to web API
    }
    ...
    ResultService.prototype.getResultsByStudentId = function (id) {
    ...
    ResultService.prototype.deleteResultById = function (id) {
